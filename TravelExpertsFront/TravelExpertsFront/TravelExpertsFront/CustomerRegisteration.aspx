   ...
   <div class="container-fluid">
    ...
    <form id="form1" runat="server">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-5">
                        ...
                        <div class="col-2"> </div>
                    <div class="col-5">
                         <asp:Label ID="lblLoginName" runat="server" class="lablestyle">*Login Name</asp:Label>
                        <asp:TextBox ID="txtLoginName" runat="server" class="form-control" placeholder=""></asp:TextBox>
        ...
        <div class="container">
            <div class="row">
                <div class="col-5">
                     <asp:Label ID="lblCustPassword" runat="server" class="lablestyle">*Password</asp:Label>
                ...
                <div class="col-2"> </div>
                <div class="col-5">
                     <asp:Label ID="lblConfirmPassword" runat="server" class="lablestyle">*Confirm Password</asp:Label>
